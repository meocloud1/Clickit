...
<header class="nexmoe-nav">
    <div class="navSize">
			...
			<div class="nav_menu">
				<ul class="menu_ul">
					<li class="menu_li"><a href="https://meocloud.my.id" target="_blank">Blog</a></li>
					<li class="menu_li"><a href="https://meocloud.digital" target="_blank">Web</a></li>
				</ul>
...
function list_files(path, files) {
  ...
  for (i in files) {
    ...
    item["modifiedTime"] = utc7indonesia(item["modifiedTime"]);
...
//时间转换
function utc7indonesia(utc_datetime) {
